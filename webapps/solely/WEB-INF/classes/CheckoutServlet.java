...
public class CheckoutServlet extends HttpServlet {
    ...
    private String html_body_before_cart_detail = """
            </ul>
                     </div>
                  </div>
               </div>
    ...
    private String html_body_after_cart_detail = """
            </div>
                        <div class="w-100"></div>
                        <div class="col-md-12">
                     ...
                     <div class="row">
                        <div class="col-md-12 text-center">
                           <p>
                              <a href="order-complete" class="btn btn-primary">Place an order</a>
                           </p>
                        </div>
                     </div>
                  </div>
    ...
    public String generateCartDetails(double subtotal) {
        double shipping = 10.00; // Shipping is always $10
    
        String cartDetails = "<div class=\"cart-detail\">" +
                                "<h2>Cart Total</h2>" +
                                "<ul>" +
                                    "<li>" +
                                        "<span>Subtotal</span>" +
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println(html_body_before_cart_detail);
        out.println(generateCartDetails(Double.parseDouble(request.getParameter("subPrice"))));
        out.println(html_body_after_cart_detail);
        out.close();
