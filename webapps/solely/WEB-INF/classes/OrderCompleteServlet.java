...
@WebServlet("/order-complete") // Configure the request URL for this servlet (Tomcat 7/Servlet 3.0 upwards)
public class OrderCompleteServlet extends HttpServlet {
    ...
    private String html_body_footer = """
                    </ul>
                                </div>
                            </div>
                        </div>
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(session!=null && !session.getAttribute("id").equals("000")){ // if session exist
            ...
            try (
                ...
                String sqlstr = "DELETE FROM cart WHERE user_id = " + session.getAttribute("id");
                int count;
